    ...
    def check_for_collisions(self):
        ...
        if self.aliens_lasers_group: # For alien lasers
            ...
            for alien_laser_sprite in self.aliens_lasers_group: 
                ...
                if pygame.sprite.spritecollide(alien_laser_sprite,self.shields_group,False) and self.boss_active == False: # Checks for shields
                ...
                if pygame.sprite.spritecollide(alien_laser_sprite,self.spaceship_group, False): # Checks for the player
                    ...
                    if self.powerup == False or 2 or self.boss_active:
                        self.lives -= 1
                        if self.lives == 0:
                            self.game_over()
                ...
                if alien_laser_sprite.type != 3 and alien_laser_sprite.bounced == False and self.boss_countdown == False:
        ...
        if self.aliens_group and self.boss_countdown == False:
